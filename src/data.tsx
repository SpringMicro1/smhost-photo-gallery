import { Album, GalleryHome } from "./gallery-types";
...
export default {
  ...
  albums: [
      ...
      images: [
        {
          ...
          description: "(small, left) This white cat with black spots is languishing on a soft bed.",
        ...
        },
        {
          id: 1,
          title: "Licking Cat",
          description: "(medium, right) This orange cat with a white belly is cleaning itself.",
          image:  "https://images.pexels.com/photos/57416/cat-sweet-kitty-animals-57416.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
          position: "right",
        },
        {
          id: 2,
          title: "Staring Cat",
          description: "(large, left) This grey cat with big, green eyes is staring right into the camera.",
          image:  "https://images.pexels.com/photos/20787/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
          size: "large",
        },
      ],
      defaultView: "list",
      allowedViews: ["list", "picture"]
    },
    {
      id: "oaisdfjgoiuhas",
      title: "Dogs",
      description: "This album is about dogs.",
      image:
    ...
    {
      id: "hbiujsendbiughreiu",
      title: "Ferrets",
      description: "This album is about ferrets.",
      image:
        "https://imgs.search.brave.com/2j-9I5NGFVyP7NSua4aVSc79dyGSnqObPEn1WFU7BZM/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5pc3RvY2twaG90/by5jb20vaWQvOTc4/NjcyMzcvcGhvdG8v/ZmVycmV0LmpwZz9z/PTYxMng2MTImdz0w/Jms9MjAmYz10aGdH/SmR5Tnl0QXk4UHRS/LUQ0SGUzbkNMRlg0/RElvWGduYVVDaWd2/MmF3PQ",
      public: true,
      editingPermissions: [],
      images: [],
      defaultView: "list",
    ...
    },
    {
      id: "aeijudfhgiuhosg",
      title: "Turtles",
      description: "This album is about turtles.",
      image:
        "https://imgs.search.brave.com/9xi9iDsAn5cj6zkJH-b9Vj3h2oNJGnUJz_Ltrc14Ma8/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzL2E0L2Rl/LzRkL2E0ZGU0ZGQw/OTU0MjFjMDAyZjMw/MGNlOGNkNmI0NjE1/LmpwZw",
      public: true,
      editingPermissions: [],
      images: [],
      defaultView: "list",
    ...
    {
      id: "iushiuyuggkjnskdujk",
      title: "Santa",
      description: "This album is about Santa.",
      image:
        "https://imgs.search.brave.com/480JgKqj8gJcUlad8i6oeMUenAMfQqGqCFZDDypH8P4/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5nZXR0eWltYWdl/cy5jb20vaWQvOTA3/OTc4NDYvcGhvdG8v/c2FudGEtY2xhdXMu/anBnP3M9NjEyeDYx/MiZ3PTAmaz0yMCZj/PWFINnR5Zmx5QkJF/LWpQSS1HTk8zc05P/WXNGc214MUY3MmNu/eXlXblRUcEk9",
      public: true,
      editingPermissions: [],
      images: [],
      defaultView: "list",
  ...
  galleryHome: {
    ...
    description: "These are the best animals, see for yourself",
    bannerImage: {
      url: "https://images.pexels.com/photos/37833/rainbow-lorikeet-parrots-australia-rainbow-37833.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      positionY: "30%",
    },
  } satisfies GalleryHome,
};
